# Reference code implementation from https://github.com/timesler/facenet-pytorch/blob/master/models/mtcnn.py

import os

import numpy as np
import torch
from networks.utils.detect_face import detect_face, extract_face
